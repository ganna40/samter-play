(() => {
  ...
  function render(){
    ...
    content.innerHTML=`<div class="page-heading"><div><span class="eyebrow">SOCIAL COOPERATIVE · PUBLIC DEMO</span><h1>공익사업</h1></div><div class="today">${c.year} 회계연도</div></div>
